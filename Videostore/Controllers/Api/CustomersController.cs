    ...
    public class CustomersController : ApiController
    {
       ...
       //GET / api /customers
        public IHttpActionResult GetCustomers(string query = null)
        {
         ...
         IEnumerable<CustomerDto> customerDtos = customersQuery.ToList().Select(Mapper.Map<Customer, CustomerDto>);
        ...
        //POST/ api /customers  - we post a customer to customers collection
        [HttpPost]
